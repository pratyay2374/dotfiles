...
local volume_popup_drawing = false

local function volume_collapse_details()
    if not volume_popup_drawing then return end
    volume_popup_drawing = false
    volume_bracket:set({
        popup = {
            drawing = false
        }
...
local function volume_toggle_details(env)
    ...
    if not volume_popup_drawing then
        volume_popup_drawing = true
        volume_bracket:set({
            popup = {
                drawing = true
            }
