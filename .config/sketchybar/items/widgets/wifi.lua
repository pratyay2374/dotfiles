...
local function toggle_details()
    local query = wifi_bracket:query()
    if not query or not query.popup then return end
...
local function copy_label_to_clipboard(env)
    local query = sbar.query(env.NAME)
    if not query or not query.label then return end
    local label = query.label.value
